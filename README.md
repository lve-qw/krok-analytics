...
Четыре вкладки под общей панелью управления: **Обзор** (5 KPI и интерактивная
оценка высвобождённого FTE), **Сценарии и автоматизация**, **Надёжность,
стоимость и риски**, **Записи**.
...
- **Карта использования** переключается между сценариями, классами и
  псевдонимизированными пользователями, а также между диалогами, токенами и
  вызовами инструментов. Клик по столбцу открывает соответствующие записи.
- **Оценка FTE** управляется ползунком минут экономии на запрос. Это явное
  сценарное допущение: измеренный расход токенов и оценка эффекта не смешиваются.
